  ...
  return (
    <div style={{ minHeight: '100dvh', background: '#0d1117', color: '#e2e8f0', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ maxWidth: 420, margin: '0 auto', padding: '6rem 16px 6rem', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 13, color: '#64748b', marginBottom: 32 }}>Offline compass + location</p>
        ...
        {/* Heading readout */}
        <div style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: '20px', marginBottom: 20 }}>
          <div style={{ fontSize: 56, fontWeight: 800, letterSpacing: '-0.03em', color: '#e2e8f0', lineHeight: 1 }}>
        ...
        {/* Location */}
        <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 12, padding: '14px 16px', marginBottom: 20, textAlign: 'left' }}>
          <div style={{ fontSize: 11, color: '#64748b', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 8 }}>📍 Location</div>
          {locError ? (
            ...
            <div style={{ fontSize: 13, color: '#475569' }}>Acquiring GPS…</div>
          )}
        </div>
