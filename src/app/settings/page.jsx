      ...
      <div style={{ maxWidth: 640, margin: '0 auto', padding: '2rem 1rem 4rem' }}>
        ...
        <Section title="Profile Information">
          ...
          <div>
            ...
            <div style={{ color: 'var(--text-subtle)', fontSize: '0.9rem', padding: '0.75rem 1rem', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 10 }}>{user?.email || user?.phone || 'QuietKeep Account'}</div>
          </div>
        </Section>
