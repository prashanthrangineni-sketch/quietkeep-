...
export default function Documents() {
  ...
  if (loading) return (<><NavbarClient /><div style={{ minHeight:'100vh', backgroundColor:'var(--bg)', display:'flex', alignItems:'center', justifyContent:'center' }}><div style={{ color:'#6366f1', fontSize:18 }}>Loading…</div></div></>);
