    ...
    <nav style={{ backgroundColor: '#0f0f1a', borderBottom: '1px solid #1e293b', padding: '12px 20px', position: 'sticky', top: 0, zIndex: 100 }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '20px', alignItems: 'center', flexWrap: 'wrap' }}>
          <Link href="/dashboard" style={{ color: isActive('/dashboard'), textDecoration: 'none', fontSize: '13px', fontWeight: '600' }}>Dashboard</Link>
          <Link href="/finance" style={{ color: isActive('/finance'), textDecoration: 'none', fontSize: '13px', fontWeight: '600' }}>Finance</Link>
          <Link href="/calendar" style={{ color: isActive('/calendar'), textDecoration: 'none', fontSize: '13px', fontWeight: '600' }}>Calendar</Link>
          <Link href="/daily-brief" style={{ color: isActive('/daily-brief'), textDecoration: 'none', fontSize: '13px', fontWeight: '600' }}>Brief</Link>
          <Link href="/documents" style={{ color: isActive('/documents'), textDecoration: 'none', fontSize: '13px', fontWeight: '600' }}>Docs</Link>
          <Link href="/driving" style={{ color: isActive('/driving'), textDecoration: 'none', fontSize: '13px', fontWeight: '600' }}>Driving</Link>
          <Link href="/settings" style={{ color: isActive('/settings'), textDecoration: 'none', fontSize: '13px', fontWeight: '600' }}>Settings</Link>
        </div>
