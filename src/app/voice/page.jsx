...
export default function VoicePage() {
  ...
  // Android back button — prevent app exit on this nested page
  useEffect(() => {
    ...
    return function() { if (handle) handle.remove(); };
  }, []);
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: '#f0f0f5', fontFamily: "'DM Sans', -apple-system, sans-serif", paddingBottom: '80px' }}>
      ...
      {/* Header */}
      <div style={{ background: 'linear-gradient(135deg, var(--bg), #0d0a18)', borderBottom: '1px solid rgba(139,92,246,0.2)', padding: '20px 16px 16px' }}>
