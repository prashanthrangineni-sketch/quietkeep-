...
export default function BudgetComponent() {
  ...
  return (
    <div style={{ marginTop: '32px' }}>
      ...
      {budgets.length > 0 && (
        <div style={{ display: 'grid', gap: '12px', marginBottom: '24px' }}>
          {budgets.map((budget) => {
            ...
            return (
              <div key={budget.id} style={{ backgroundColor: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '12px', padding: '14px' }}>
                ...
                {status.over && (
                  <div style={{ color: 'var(--red)', fontSize: '10px', marginTop: '4px' }}>
      ...
      {/* Add Budget Form */}
      {showForm && (
        <div style={{ backgroundColor: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '14px', padding: '20px', marginBottom: '24px' }}>
          <h3 style={{ fontSize: '16px', fontWeight: '700', color: 'var(--text)', margin: '0 0 16px' }}>Set Budget</h3>
