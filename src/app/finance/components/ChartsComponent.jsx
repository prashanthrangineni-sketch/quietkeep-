...
export default function ChartsComponent() {
  ...
  if (expenses.length === 0) {
    return (
      <div style={{ marginTop: '32px', backgroundColor: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px', textAlign: 'center' }}>
        <div style={{ fontSize: '14px', color: 'var(--text-muted)' }}>📊 Add expenses to see charts</div>
      </div>
    );
  }
  ...
  return (
    <div style={{ marginTop: '32px' }}>
      ...
      <div style={{ backgroundColor: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px', minHeight: '350px' }}>
        {/* Category View - Bar Chart Style */}
        {activeTab === 'category' && categoryData.length > 0 && (
          <div>
            <h3 style={{ fontSize: '14px', fontWeight: '600', margin: '0 0 16px', color: 'var(--text)' }}>Expenses by Category</h3>
        ...
        {activeTab === 'trend' && trendData.length > 0 && (
          <div>
            <h3 style={{ fontSize: '14px', fontWeight: '600', margin: '0 0 16px', color: 'var(--text)' }}>Last 6 Months</h3>
            <div style={{ display: 'grid', gap: '12px' }}>
        ...
        {activeTab === 'category' && categoryData.length === 0 && (
          <div style={{ textAlign: 'center', color: 'var(--text-muted)' }}>No expense data</div>
        )}

        {activeTab === 'budget' && budgetData.length === 0 && (
          <div style={{ textAlign: 'center', color: 'var(--text-muted)' }}>No budget data</div>
        )}
      </div>
    </div>
  );
